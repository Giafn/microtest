...
const ProfileDetails = () => {
  ...
  const updateProfileImage = async (file) => {
    ...
    try {
      await axios.patch(import.meta.env.VITE_BACKEND_URL + "/api/users/update-image", formData, {
        headers: {
          Authorization: `Bearer ${bearerToken}`,
  ...
  const updateProfile = async (updatedData) => {
    try {
      const response = await axios.patch(import.meta.env.VITE_BACKEND_URL + "/api/users/update", updatedData, {
        headers: {
          Authorization: `Bearer ${bearerToken}`,
        },
      });
