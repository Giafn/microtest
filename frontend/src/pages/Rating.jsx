...
const Rating = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await axios.get(import.meta.env.VITE_BACKEND_URL + "/api/ratings", {
          headers: {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await axios.get(import.meta.env.VITE_BACKEND_URL + "/api/ratings/buyed-item", {
          headers: {
            Authorization: `Bearer ${bearerToken}`,
          },
        });
