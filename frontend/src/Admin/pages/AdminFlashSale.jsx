...
const AdminFlashSale = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await fetch(import.meta.env.VITE_BACKEND_URL + '/api/items'); // Ganti URL sesuai endpoint Anda
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_BACKEND_URL + '/api/flashsales', { // Ganti URL sesuai endpoint Anda
        method: 'POST',
        headers: {
